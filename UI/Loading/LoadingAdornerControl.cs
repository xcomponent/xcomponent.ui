...
{
    public class LoadingAdornedControl : ContentControl
    {
        /// <summary>
        /// Dependency properties.
        /// </summary>
        public static readonly DependencyProperty IsAdornerVisibleProperty =
            DependencyProperty.Register("IsAdornerVisible", typeof(bool), typeof(LoadingAdornedControl),
        ...
        public static readonly DependencyProperty AdornerContentProperty =
            DependencyProperty.Register("AdornerContent", typeof(FrameworkElement), typeof(LoadingAdornedControl),
                new FrameworkPropertyMetadata(AdornerContent_PropertyChanged));

        public static readonly DependencyProperty AdornerTimeoutContentProperty = DependencyProperty.Register(
            "AdornerTimeoutContent", typeof (FrameworkElement), typeof (LoadingAdornedControl), new PropertyMetadata(default(FrameworkElement)));

        public FrameworkElement AdornerTimeoutContent
        {
            get { return (FrameworkElement) GetValue(AdornerTimeoutContentProperty); }
            set { SetValue(AdornerTimeoutContentProperty, value); }
        }

        public static readonly DependencyProperty HorizontalAdornerPlacementProperty =
            DependencyProperty.Register("HorizontalAdornerPlacement", typeof(AdornerPlacement), typeof(LoadingAdornedControl),
        ...
        public static readonly DependencyProperty VerticalAdornerPlacementProperty =
            DependencyProperty.Register("VerticalAdornerPlacement", typeof(AdornerPlacement), typeof(LoadingAdornedControl),
                new FrameworkPropertyMetadata(AdornerPlacement.Inside));

        public static readonly DependencyProperty AdornerOffsetXProperty =
            DependencyProperty.Register("AdornerOffsetX", typeof(double), typeof(LoadingAdornedControl));
        public static readonly DependencyProperty AdornerOffsetYProperty =
            DependencyProperty.Register("AdornerOffsetY", typeof(double), typeof(LoadingAdornedControl));

        /// <summary>
        /// Commands.
        /// </summary>
        public static readonly RoutedCommand ShowAdornerCommand = new RoutedCommand("ShowAdorner", typeof(LoadingAdornedControl));
        public static readonly RoutedCommand HideAdornerCommand = new RoutedCommand("HideAdorner", typeof(LoadingAdornedControl));

        public LoadingAdornedControl()
        {
        ...
        public void ShowTimeoutMessage()
        {
            ...
            if (this.AdornerTimeoutContent != null)
            {
                this.AdornerContent = this.AdornerTimeoutContent;
        ...
        /// </summary>
        private LoadingAdorner adorner = null;
        ...
        /// </summary>
        static LoadingAdornedControl()
        {
            CommandManager.RegisterClassCommandBinding(typeof(LoadingAdornedControl), ShowAdornerCommandBinding);
            CommandManager.RegisterClassCommandBinding(typeof(LoadingAdornedControl), HideAdornerCommandBinding);
        }
        ...
        {
            LoadingAdornedControl c = (LoadingAdornedControl)target;
            c.ShowAdorner();
        }
        ...
        {
            LoadingAdornedControl c = (LoadingAdornedControl)o;
        ...
        private void ShowAdornerInternal()
        {
            ...
            if (this.AdornerContent != null)
            {
                ...
                if (this.adornerLayer != null)
                {
                    this.adorner = new LoadingAdorner(this.AdornerContent, this, this.HorizontalAdornerPlacement, this.VerticalAdornerPlacement,
